...
<html lang="en">
    <head>
        <meta http-equiv="refresh" content="5; url=https://godoc.org/github.com/MaxBreida/mongo-go-driver/{{.}}">
        <meta name=go-import content="github.com/MaxBreida/mongo-go-driver git https://github.com/mongodb/mongo-go-driver.git">
        <meta name="go-source" content="github.com/MaxBreida/mongo-go-driver https://github.com/mongodb/mongo-go-driver https://github.com/mongodb/mongo-go-driver/tree/master{/dir} https://github.com/mongodb/mongo-go-driver/blob/master{/dir}/{file}#L{line}">
    </head>
    <body>
        Redirecting to docs...
    </body>
...
func main() {
	...
	for _, pkg := range pkgs {
		...
		dirs = append(dirs, strings.TrimPrefix(pkg.PkgPath, "github.com/MaxBreida/mongo-go-driver"))
	}
